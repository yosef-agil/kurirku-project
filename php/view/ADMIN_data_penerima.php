    ...
    <header>
        <div class="sidebar-menu">
            ...
            <a href="/" style="margin-left:16px;" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none fs-4"> 
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li> <a href="D_admin.php" class="nav-link text-white">Dashboard</a> </li>
                    <li class="nav-item"> <a href="ADMIN_data_penerima.php" class="nav-link active"  aria-current="page">Data Penerima</a> </li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <form class="d-flex">
                        <input class="form-control me-2" type="search" placeholder="Cari berdasarkan id" aria-label="Search">
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <?php
                            ...
                            echo "<tr class='data-table'>
                                ...
                                <td>".$key['kode_post']."</td>
                                <td><a href='../control/hapusPenerima_controller.php?id=".$key['id_penerima']."' class='btn btn-danger btn-sm'>Hapus</a></td>";
                            $no++;
                            };
                        ?>
                        </tbody>
