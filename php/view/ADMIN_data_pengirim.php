        ...
        <div class="sidebar-menu">
            ...
            <a href="/" style="margin-left:16px;" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none fs-4"> 
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item"> <a href="ADMIN_data_pengirim.php" class="nav-link active" aria-current="page">Data Pengirim</a> </li>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <?php
                            ...
                            echo "<tr class='data-table'>
                                ...
                                <td>".$key['nomer']."</td>
                                <td>".$key['email']."</td>
                                <td><a href='hapus_data.php' class='btn btn-danger btn-sm'>Hapus</a></td>";
                            $no++;
                            };
                        ?>
                        </tbody>
